...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('vendor/laravel-filemanager/css/mime-icons.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset(('vendors/tagsinput/tagify.css')) }}">
...
{{--    <a data-action="use" data-multiple="true"><i class="fas fa-check"></i>{{ trans('laravel-filemanager::lfm.btn-confirm') }}</a>--}}
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
              ...
              <div class="controls text-center">
                ...
                <div class="input-group w-100">
                    ...
                    <input type="text" class="form-control"
                           ...
                           id="tags_name"
                    />
                  <a class="btn btn-primary w-100 text-white" style="margin-top: 10px;" id="upload-button">{{ trans('laravel-filemanager::lfm.message-choose') }}</a>
                </div>
              </div>
            </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-success w-100" data-dismiss="modal" id="upload_all">Upload</button>
  ...
  <script src="{{ asset(('vendors/tagsinput/jQuery.tagify.min.js')) }}"></script>

  <script>
      $('[name=tags_name]').tagify();
  ...
  <script>
    Dropzone.options.uploadForm = {
      ...
      dictDefaultMessage: lang['message-drop'],
        ...
        dictRemoveFile: 'Xoá',
      init: function() {
          var submitButton = document.querySelector("#upload_all")
