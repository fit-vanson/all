...
//    'middleware' => 'auth.apikey'
    ...
    Route::get('wallpaper/add/set',[ApiV3Controller::class, 'api_add_set']);
    Route::get('wallpaper/add/view',[ApiV3Controller::class, 'api_add_view']);
    Route::get('wallpaper/add/download',[ApiV3Controller::class, 'api_add_download']);
