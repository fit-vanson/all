...
//    'middleware' => 'auth.apikey'
    ...
    Route::put('wallpaper/add/set',[ApiV3Controller::class, 'api_add_set']);
    Route::put('wallpaper/add/view',[ApiV3Controller::class, 'api_add_view']);
    Route::put('wallpaper/add/download',[ApiV3Controller::class, 'api_add_download']);
